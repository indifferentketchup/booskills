...
DEFAULT_AGENTS_CLOUD = {
    ...
    "source-researcher": pi("xiaomi", "mimo-v2.5"),
...
DEFAULT_AGENTS_LOCAL = {
    ...
    "source-researcher": local("qwen3.6-35b-a3b"),
...
DEFAULT_AGENTS_SUB_LOW = {
    ...
    "source-researcher": openai_codex("gpt-5.1-codex-mini"),
...
DEFAULT_AGENTS_SUB_MID = {
    ...
    "source-researcher": openai_codex("gpt-5.4"),
